...
import { WebForms Grid OverviewPage } from '../pages/WebForms Grid OverviewPage';

/**
 * WebForms Grid Overview Test Suite
 * 
 * Auto-generated from CSV test cases
 */
test.describe('WebForms Grid Overview Tests', () => {
  let WebForms Grid OverviewPage: WebForms Grid OverviewPage;

  test.beforeEach(async ({ page }) => {
    WebForms Grid OverviewPage = new WebForms Grid OverviewPage(page);
    await WebForms Grid OverviewPage.goto();
  });
